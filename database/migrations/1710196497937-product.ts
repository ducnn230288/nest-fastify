...
export class Product1710196497937 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "product"."order" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isDeleted" TIMESTAMP, "isDisabled" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "user_id" character varying NOT NULL, "status" integer NOT NULL DEFAULT '0', "order_code" character varying NOT NULL, "total" integer NOT NULL, "reason" character varying NOT NULL DEFAULT '', "productStoreId" uuid NOT NULL, "userId" uuid, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product"."product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isDeleted" TIMESTAMP, "isDisabled" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "description" character varying NOT NULL, "quantity" integer NOT NULL, "price" integer NOT NULL, "images" text NOT NULL DEFAULT '', "status" integer NOT NULL DEFAULT '0', "slug" character varying NOT NULL, "mass" integer NOT NULL, "discount" integer NOT NULL DEFAULT '0', "product_category_id" uuid NOT NULL, "product_store_id" uuid NOT NULL, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product"."order_product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isDeleted" TIMESTAMP, "isDisabled" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "product_id" character varying NOT NULL, "order_id" character varying NOT NULL, "name" character varying NOT NULL, "price" integer NOT NULL, "quantity" integer NOT NULL, "discount" integer NOT NULL DEFAULT '0', "total" integer NOT NULL, "productId" uuid, "orderId" uuid, CONSTRAINT "PK_539ede39e518562dfdadfddb492" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product"."order_address" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isDeleted" TIMESTAMP, "isDisabled" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "code_ward" character varying NOT NULL, "code_district" character varying NOT NULL, "code_province" character varying NOT NULL, "specific_address" character varying NOT NULL, "order_id" character varying NOT NULL, "address_id" character varying NOT NULL, "codeWard" character varying, "codeDistrict" character varying, "codeProvince" character varying, "orderId" uuid, "addressId" uuid, CONSTRAINT "REL_d82a2840b5e5c98c569d75e92e" UNIQUE ("orderId"), CONSTRAINT "PK_f07603e96b068aae820d4590270" PRIMARY KEY ("id"))`);
