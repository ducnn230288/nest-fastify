...
export class Member1698359719624 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "member"."task_timesheet" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isDeleted" TIMESTAMP, "isDisabled" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "start" TIMESTAMP NOT NULL, "finish" TIMESTAMP, "note" character varying, "user_id" uuid NOT NULL, CONSTRAINT "PK_d556100ebc2e29cb0471a48583b" PRIMARY KEY ("id"))`);
    await queryRunner.query(`CREATE TABLE "member"."booking" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isDeleted" TIMESTAMP, "isDisabled" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "description" character varying NOT NULL, "start_time" TIMESTAMP, "end_time" TIMESTAMP, "user_id" uuid NOT NULL, "type_code" character varying, "item_code" character varying, CONSTRAINT "PK_49171efc69702ed84c812f33540" PRIMARY KEY ("id"))`);
    await queryRunner.query(`CREATE TABLE "member"."day_off" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isDeleted" TIMESTAMP, "isDisabled" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "code" character varying NOT NULL, "type" integer NOT NULL, "status" integer NOT NULL DEFAULT '0', "reason" character varying, "time" integer NOT NULL, "time_number" real, "image" character varying, "date_leave_start" TIMESTAMP NOT NULL, "date_leave_end" TIMESTAMP NOT NULL, "approved_at" TIMESTAMP, "approved_by_id" uuid, "reason_reject" character varying, "staff_id" uuid NOT NULL, "manager_id" uuid, CONSTRAINT "UQ_6ae9d51238edf6234ac33b37ad0" UNIQUE ("code"), CONSTRAINT "PK_4ebe4c08c950e3dbc87f0249811" PRIMARY KEY ("id"))`);
    await queryRunner.query(`CREATE TABLE "member"."user_team" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isDeleted" TIMESTAMP, "isDisabled" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "description" character varying, "manager_id" uuid, CONSTRAINT "PK_155dbc144ff2bd4713fdf1f6c77" PRIMARY KEY ("id"))`);
    await queryRunner.query(`CREATE TABLE "member"."question" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isDeleted" TIMESTAMP, "isDisabled" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "type_code" character varying, "question" character varying, "options" character varying NOT NULL, "correct" character varying NOT NULL, "image" character varying, "level" real, CONSTRAINT "PK_21e5786aa0ea704ae185a79b2d5" PRIMARY KEY ("id"))`);
    await queryRunner.query(`CREATE TABLE "member"."question_test" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isDeleted" TIMESTAMP, "isDisabled" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "point" real, "answer" jsonb NOT NULL DEFAULT '{}', "user_id" uuid NOT NULL, CONSTRAINT "PK_48dff3c387f955f8f3a7d3f734c" PRIMARY KEY ("id"))`);
    ...
    await queryRunner.query(`CREATE TABLE "member"."task" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isDeleted" TIMESTAMP, "isDisabled" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "project_code" character varying, "code" character varying NOT NULL, "name" character varying NOT NULL, "content" jsonb NOT NULL DEFAULT '{}', "start" TIMESTAMP NOT NULL, "finish" TIMESTAMP, "deadline" TIMESTAMP NOT NULL, "priority" "member"."task_priority_enum" NOT NULL DEFAULT '0', "status" "member"."task_status_enum" NOT NULL DEFAULT '0', "level" real, "order" real DEFAULT '0', "complete" real, "successors" character varying NOT NULL, "predecessors" character varying NOT NULL, "hours" real, "manager_id" uuid, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
    await queryRunner.query(`CREATE TABLE "member"."task_work" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isDeleted" TIMESTAMP, "isDisabled" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "hours" real, "task_id" uuid NOT NULL, "timesheet_id" uuid NOT NULL, CONSTRAINT "PK_e91316aba5c0fa394f53cd94bf4" PRIMARY KEY ("id"))`);
    await queryRunner.query(`CREATE TABLE "member"."comment" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isDeleted" TIMESTAMP, "isDisabled" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "content" character varying NOT NULL, "user_id" character varying NOT NULL, "table_id" character varying NOT NULL, "type" character varying NOT NULL, CONSTRAINT "PK_0b0e4bbc8415ec426f87f3a88e2" PRIMARY KEY ("id"))`);
    await queryRunner.query(`CREATE TABLE "member"."task_sub" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isDeleted" TIMESTAMP, "isDisabled" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "completed" TIMESTAMP, "image" character varying, "task_id" uuid NOT NULL, CONSTRAINT "PK_e00d47b1d1e66ea2acfa91b24c8" PRIMARY KEY ("id"))`);
    ...
    await queryRunner.query(`ALTER TABLE "core"."data_translation" DROP COLUMN "content"`);
    await queryRunner.query(`ALTER TABLE "core"."data_translation" ADD "content" character varying`);
    await queryRunner.query(`ALTER TABLE "core"."post_translation" DROP COLUMN "content"`);
    await queryRunner.query(`ALTER TABLE "core"."post_translation" ADD "content" character varying`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "core"."post_translation" DROP COLUMN "content"`);
    await queryRunner.query(`ALTER TABLE "core"."post_translation" ADD "content" jsonb NOT NULL DEFAULT '{}'`);
    await queryRunner.query(`ALTER TABLE "core"."data_translation" DROP COLUMN "content"`);
    await queryRunner.query(`ALTER TABLE "core"."data_translation" ADD "content" jsonb NOT NULL DEFAULT '{}'`);
