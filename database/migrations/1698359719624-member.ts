...
export class Member1698359719624 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TYPE "public"."task_priority_enum" AS ENUM('-1', '0', '1')`);
    await queryRunner.query(`CREATE TYPE "public"."task_status_enum" AS ENUM('-1', '0', '1')`);
    await queryRunner.query(
      `CREATE TABLE "task" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "is_deleted" TIMESTAMP, "is_disabled" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "project_code" character varying, "code" character varying NOT NULL, "name" character varying NOT NULL, "content" jsonb NOT NULL DEFAULT '{}', "start" TIMESTAMP NOT NULL, "finish" TIMESTAMP, "deadline" TIMESTAMP NOT NULL, "priority" "public"."task_priority_enum" NOT NULL DEFAULT '0', "status" "public"."task_status_enum" NOT NULL DEFAULT '0', "level" real, "order" real DEFAULT '0', "complete" real, "successors" character varying NOT NULL, "predecessors" character varying NOT NULL, "hours" real, "manager_id" uuid, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "user_tasks_assignees_task" ("user_id" uuid NOT NULL, "user_task_id" uuid NOT NULL, CONSTRAINT "PK_61b3b808a5c8a5fd0f896fb3213" PRIMARY KEY ("user_id", "user_task_id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_ca6bc2b9e03c31d76c1d343801" ON "user_tasks_assignees_task" ("user_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_93d2e1c81a267bb3779bab5f80" ON "user_tasks_assignees_task" ("user_task_id") `,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "task" ADD CONSTRAINT "FK_e061e308a652cd1a79c15ebc18b" FOREIGN KEY ("manager_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_tasks_assignees_task" ADD CONSTRAINT "FK_ca6bc2b9e03c31d76c1d3438018" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_tasks_assignees_task" ADD CONSTRAINT "FK_93d2e1c81a267bb3779bab5f803" FOREIGN KEY ("user_task_id") REFERENCES "task"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "user_tasks_assignees_task" DROP CONSTRAINT "FK_93d2e1c81a267bb3779bab5f803"`);
    await queryRunner.query(`ALTER TABLE "user_tasks_assignees_task" DROP CONSTRAINT "FK_ca6bc2b9e03c31d76c1d3438018"`);
    ...
    await queryRunner.query(`ALTER TABLE "task" DROP CONSTRAINT "FK_e061e308a652cd1a79c15ebc18b"`);
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX_93d2e1c81a267bb3779bab5f80"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_ca6bc2b9e03c31d76c1d343801"`);
    await queryRunner.query(`DROP TABLE "user_tasks_assignees_task"`);
