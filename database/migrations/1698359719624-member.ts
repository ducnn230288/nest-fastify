...
export class Member1698359719624 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "booking" ADD CONSTRAINT "FK_a4108479a7402c440d98205ff09" FOREIGN KEY ("type") REFERENCES "code_type"("code") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "booking" ADD CONSTRAINT "FK_631f222540372c59aefc6cebf75" FOREIGN KEY ("itemCode") REFERENCES "code"("code") ON DELETE NO ACTION ON UPDATE NO ACTION`);
