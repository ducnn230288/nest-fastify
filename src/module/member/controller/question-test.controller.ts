...
import { P_QUESTION_CREATE, P_QUESTION_TEST_CREATE, P_QUESTION_TEST_LISTED, QuestionService, QuestionTestService } from "@service";
import { User } from "@model";

@Headers('question-test')
export class QuestionTestController {
    constructor(
        private readonly service: QuestionTestService
    ) { }
    ...
    @Get('')
    async findAll(@I18n() i18n: I18nContext, @Query() paginationQuery: PaginationQueryDto, @AuthUser() user: User): Promise<any> {
